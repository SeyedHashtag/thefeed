...
بسازید.** سرور خالی‌بودن مخزن را تشخیص می‌دهد، فهرست اشیائش را ریست می‌کند و
فایل‌ها را در صورت نیاز دوباره آپلود می‌کند — نیازی به پاک‌کردن دستی وضعیت نیست.
در این فاصله رسانه از طریق DNS در دسترس می‌ماند.
